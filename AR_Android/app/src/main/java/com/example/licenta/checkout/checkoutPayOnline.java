...
public class checkoutPayOnline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price.setText("Total price: "+sPrice);
        ...
        placeOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cardCVVS.equals("") && cardNumberS.equals("") && cardMonthS.equals("") && cardYearS.equals("")) {
                    Toast.makeText(checkoutPayOnline.this, "Complete your card data", Toast.LENGTH_SHORT).show();
                } else {
                    items items = new items(sPrice, "Online Payment");
