...
public class TablesCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tables.add(new items("Table1", 23, R.drawable.table1, R.drawable.table11, R.drawable.table111, "table1.sfb", tablesDescription));
        tables.add(new items("Table2", 43, R.drawable.table2, R.drawable.table22, R.drawable.table222, "table2.sfb", tablesDescription));
        tables.add(new items("Table3", 54, R.drawable.table3, R.drawable.table33, R.drawable.table333, "table3.sfb", tablesDescription));
        tables.add(new items("Table4", 34, R.drawable.table4, R.drawable.table44, R.drawable.table444, "table4.sfb", tablesDescription));
        tables.add(new items("Table5", 65, R.drawable.table5, R.drawable.table55, R.drawable.table555, "table5.sfb", tablesDescription));
