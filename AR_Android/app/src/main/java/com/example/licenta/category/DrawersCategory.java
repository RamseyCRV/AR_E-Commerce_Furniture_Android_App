...
public class DrawersCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawers.add(new items("Drawer1", 23, R.drawable.drawer1, R.drawable.drawer11, R.drawable.drawer111, "drawer1.sfb", drawersCategory));
        drawers.add(new items("Drawer2", 43, R.drawable.drawer2, R.drawable.drawer22, R.drawable.drawer222, "drawer2.sfb", drawersCategory));
        drawers.add(new items("Drawer3", 54, R.drawable.drawer3, R.drawable.drawer33, R.drawable.drawer333, "drawer3.sfb", drawersCategory));
        drawers.add(new items("Drawer4", 34, R.drawable.drawer4, R.drawable.drawer44, R.drawable.drawer444, "drawer4.sfb", drawersCategory));
        drawers.add(new items("Drawer5", 65, R.drawable.drawer5, R.drawable.drawer55, R.drawable.drawer555, "drawer5.sfb", drawersCategory));
