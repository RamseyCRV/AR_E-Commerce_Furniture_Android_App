...
public class DeskCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desks.add(new items("Desk1", 23, R.drawable.desk1, R.drawable.desk11, R.drawable.desk111, "desk1.sfb", deskDescription));
        desks.add(new items("Desk2", 43, R.drawable.desk2, R.drawable.desk22, R.drawable.desk222, "desk2.sfb", deskDescription));
        desks.add(new items("Desk3", 54, R.drawable.desk3, R.drawable.desk33, R.drawable.desk333, "desk3.sfb", deskDescription));
        desks.add(new items("Desk4", 34, R.drawable.desk4, R.drawable.desk44, R.drawable.desk444, "desk4.sfb", deskDescription));
        desks.add(new items("Desk5", 65, R.drawable.desk5, R.drawable.desk55, R.drawable.desk555, "desk5.sfb", deskDescription));
