...
public class ChairsCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chairs.add(new items("Chair1", 42, R.drawable.chair1, R.drawable.chair11, R.drawable.chair111,  "chair1.sfb" ,chairsDescription));
        chairs.add(new items("Chair2", 46, R.drawable.chair2, R.drawable.chair22, R.drawable.chair222,  "chair2.sfb",chairsDescription));
        chairs.add(new items("Chair3", 54, R.drawable.chair3, R.drawable.chair33, R.drawable.chair333,  "chair3.sfb",chairsDescription));
        chairs.add(new items("Chair4", 38, R.drawable.chair4, R.drawable.chair44, R.drawable.chair444,  "chair4.sfb",chairsDescription));
        chairs.add(new items("Chair5", 65, R.drawable.chair5, R.drawable.chair55, R.drawable.chair555, "chair5.sfb",chairsDescription));
